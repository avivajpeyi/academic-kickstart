...
* Null Hypothesis, $\mathcal{H}_0: n(t) = s(t)$, and
* GW Hypothesis, $\mathcal{H}: n(t) = s(t) - h(t)$.

[Bayes theorem] can answer which of the two hypotheses are favoured by the data with an odds ratio:
\begin{equation} \label{eq:odds}
\begin{split}
\mathcal{O}(\mathcal{H}| s) & =  \frac{P(\mathcal{H}|s)}{ P(\mathcal{H}_0 | s)} .
\end{split}
\end{equation}
...
\begin{split}
 p_n(\vec{n}) &=  \\lim_{\Delta t \to 0}\frac{1}{(\sigma\sqrt{2\pi})^N}\ \text{exp}\left( \frac{-1}{2\sigma^2} \sum^{N-1}_{i=0} n_i^2\right) \\\\
             &\approx  \\lim_{\Delta t \to 0} \text{exp}\left( \frac{-1}{2\sigma^2\Delta t} \sum^{N-1}_{i=0} n_i^2 \Delta t\right) \\\\
             &\approx  \text{exp}\left( \frac{-1}{\text{PSD}(f)} \int^{T}_{0} n(t)^2 dt\right) \\\\
             &\approx  \text{exp}\left( \frac{-1}{\text{PSD}(f)} \int^{T}_{0} n(t)^2 dt\right) \\\\
\end{split}
\end{equation}
...
{{< iframe html="gaussian_pulse.html" height="700px">}}
### Finding a Gaussian Pulse with a Square Template
{{< iframe html="square.html" height="700px">}}
### Finding a Square with a Gaussian Pulse Template
{{< iframe html="gaussian_pulse_to_find_square.html" height="700px">}}
